/**
 * PersonStatefulCallbackHandler.java
 *
...
/**
 *  PersonStatefulCallbackHandler Callback class, Users can extend this class and implement
 *  their own receiveResult and receiveError methods.
 */
public abstract class PersonStatefulCallbackHandler {
     ...
     */
    public PersonStatefulCallbackHandler(Object clientData) {
     ...
     */
    public PersonStatefulCallbackHandler() {
    ...
    public void receiveResultgetGender(
        PersonStatefulStub.GetGenderResponse result) {
    }
    ...
    public void receiveResultsayHello(
        PersonStatefulStub.SayHelloResponse result) {
    }
    ...
    public void receiveResultgetName(
        PersonStatefulStub.GetNameResponse result) {
    }
    ...
    public void receiveResultgetAge(
        PersonStatefulStub.GetAgeResponse result) {
    }
